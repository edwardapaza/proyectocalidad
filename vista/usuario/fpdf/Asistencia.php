...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE ASISTENCIA DE ESTUDIANTES "), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Cell(30, 10, $campo["fkcodalumno"], 1, 0, 'C', 0);
$pdf->Cell(40, 10, $campo["fknomalumno"], 1, 0, 'C', 0);
$pdf->Cell(40, 10, $campo["fkapealumno"], 1, 0, 'C', 0);
$pdf->Cell(85, 10, $campo["fecha"], 1, 0, 'C', 0);
$pdf->Cell(40, 10, $campo["estado"], 1, 1, 'C', 0);
}
mysqli_close($link); 

$pdf->Output('AsistenciaSteveJobs.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
?>
