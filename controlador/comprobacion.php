...
<html>
<head>
  <title>Bienvenido administrador - Agenda Jobs</title>
...
<body onload="redireccionar()">
  <div class="container">
    <div class="card">
      <div class="card-body">
        <h1 class="card-title">Bienvenido, te has autenticado como Administrador</h1>
        <p>Redireccionando en <span id="contador">3</span> segundos...</p>
        <a href="../menu_admin.php" class="btn btn-success btn-lg btn-start">Comienza aquí</a>
      </div>
    </div>
  </div>  
